...
/*
	...
	File Description	:	Wrapper functions for the TibrvFtMonitor class.
...
//	////////////////////////////////////////////////////////////////////////////
TibrvNetTransport *GetTransport(const TibrvFtMonitor &ft_monitor)
{
	TibrvTransport *out_transport = ft_monitor.getTransport();

	if (out_transport == NULL)
		throw RvException("Invocation of 'TibrvFtMonitor::getTransport()' "
