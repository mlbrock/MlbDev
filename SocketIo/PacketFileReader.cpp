...
/*
	...
	File Description	:	Implementation of the PacketFileReader class.
...
// ////////////////////////////////////////////////////////////////////////////
PacketFileReader::PacketFileReader(const std::string &file_name,
...
/*
	CODE NOTE: Not really an error to have no data in the file. To be removed.
		if (file_size_ < 1)
...
// ////////////////////////////////////////////////////////////////////////////
std::string PacketFileReader::GetFileName() const
{
	return(file_name_);
}
// ////////////////////////////////////////////////////////////////////////////
...
// ////////////////////////////////////////////////////////////////////////////
unsigned long long PacketFileReader::GetFileSize() const
{
	return(file_size_);
}
// ////////////////////////////////////////////////////////////////////////////
...
// ////////////////////////////////////////////////////////////////////////////
unsigned long long PacketFileReader::GetFileOffset() const
{
	return(file_offset_);
}
// ////////////////////////////////////////////////////////////////////////////
...
// ////////////////////////////////////////////////////////////////////////////
unsigned long long PacketFileReader::GetPacketOffset() const
{
...
// ////////////////////////////////////////////////////////////////////////////
bool PacketFileReader::GetPacket(std::size_t &packet_length,
	...
	MsgTimeSecsType &time_secs, MsgTimeNSecsType &time_nsecs)
{
	...
	::memcpy(&tmp_length, file_data_sptr_.get() + file_offset_,
		sizeof(tmp_length));
	...
	packet_ptr      = file_data_sptr_.get() + file_offset_;
...
// ////////////////////////////////////////////////////////////////////////////
bool PacketFileReader::GetPacket(const void *&begin_ptr, const void *&end_ptr)
{
	IpAddressType ip_address;
	IpPortType    ip_port;
...
// ////////////////////////////////////////////////////////////////////////////
unsigned int PacketFileReader::GetPacketCount()
{
...
// ////////////////////////////////////////////////////////////////////////////
bool PacketFileReader::SeekToPacket(unsigned int packet_index)
{
	unsigned int packet_count;
...
// ////////////////////////////////////////////////////////////////////////////
void PacketFileReader::SeekToOffset(unsigned long long file_offset,
...
// ////////////////////////////////////////////////////////////////////////////
bool PacketFileReader::LoadFile()
{
	if (file_is_loaded_)
		return(false);
...
// ////////////////////////////////////////////////////////////////////////////
const unsigned char *PacketFileReader::GetBeginPtr() const
{
...
// ////////////////////////////////////////////////////////////////////////////
const unsigned char *PacketFileReader::GetEndPtr() const
{
...
// ////////////////////////////////////////////////////////////////////////////
void PacketFileReader::ReadTimestampHeader(MsgTimeSecsType &time_secs,
	MsgTimeNSecsType &time_nsecs)
{
...
// ////////////////////////////////////////////////////////////////////////////
void PacketFileReader::ReadIpSourceHeader(IpAddressType &ip_address,
	IpPortType &ip_port)
{
...
// ////////////////////////////////////////////////////////////////////////////
void PacketFileReader::SeekToOffsetFile(unsigned long long file_offset,
	std::ios_base::seekdir offset_base)
{
...
int main(int argc, char **argv)
{
	...
	try {
		...
		for (int count_1 = 1; count_1 < argc; ++count_1) {
			...
			if (IsPacketFormatString(argv[count_1] + 1, tmp_packet_format)) {
				...
				try {
					...
					PacketFileReader  packet_reader(argv[count_1], packet_format);
