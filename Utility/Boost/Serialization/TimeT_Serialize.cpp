...
MLB_BOOSTX_SERIAL_TEMPLATE_SPLIT(MLB::Utility::TimeT)
...
MLB_BOOSTX_SERIAL_DECL_Serialize_binary(MLB::Utility::TimeT)

	//	Force instantiation of text functions...
MLB_BOOSTX_SERIAL_DECL_Split_text(MLB::Utility::TimeT)

	//	Force instantiation of the xml functions...
MLB_BOOSTX_SERIAL_DECL_Split_xml(MLB::Utility::TimeT)

	// Force instantiation of the Serialize{Load|Save}{Binary|Text|Xml} funcs.
MLB_BOOSTX_SerializeLoadSave(MLB::Utility::TimeT)
...
template <>
	...
	const MLB::Utility::TimeT &datum, const unsigned int)
{
	s_archive
		& datum.datum_;
}
...
template <>
	...
	MLB::Utility::TimeT &datum, const unsigned int)
{
	s_archive
		& datum.datum_;
}
...
// ////////////////////////////////////////////////////////////////////////////
template <typename SArchive>
	void load(SArchive &s_archive, MLB::Utility::TimeT &datum,
		const unsigned int)
{
	...
	datum = MLB::Utility::TimeT::FromString(tmp_datum);
}
// ////////////////////////////////////////////////////////////////////////////

// ////////////////////////////////////////////////////////////////////////////
template <typename SArchive>
	void serialize(SArchive &s_archive, MLB::Utility::TimeT &datum,
...
int main()
{
	...
	std::cout << "Test routine for Boost Serialization of class 'TimeT'" <<
		std::endl;
	std::cout << "---- ------- --- ----- ------------- -- ----- -------" <<
		std::endl;
	...
	try {
		TimeT test_datum;
		TEST_Serialization(test_datum, "TimeT");
	}
