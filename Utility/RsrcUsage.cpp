...
//	////////////////////////////////////////////////////////////////////////////
std::vector<std::string> RsrcUsage::ToStringList(RsrcUsageEmptyFormat null_format_type,
	unsigned int text_width, const std::string &separator) const
{
...
//	////////////////////////////////////////////////////////////////////////////
std::vector<std::string> &RsrcUsage::ToStringList(std::vector<std::string> &out_list,
	RsrcUsageEmptyFormat null_format_type, unsigned int text_width,
	const std::string &separator) const
{
...
/*	BOH
   ...
   COPYRIGHT   :	Copyright 1992 - 2017 Michael L. Brock
...
int main(int argc, char **argv)
{
	...
	try {
		...
		for (count_1 = 1; count_1 < static_cast<unsigned int>(argc); ++count_1) {
			ParseCmdLineArg::ParseCmdLineDatum(argv[count_1], process_id);
