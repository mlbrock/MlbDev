...
// ////////////////////////////////////////////////////////////////////////////
SQLRETURN ExtendedFetch(SQLHSTMT StatementHandle,
	...
	OdbcThrowFlags::Flags throw_flags)
{
	return(OdbcWrapper_THROW_STATUS_IF_LEVEL_1(throw_flags,
		SQL_HANDLE_STMT, StatementHandle, ::SQLExtendedFetch,
		(StatementHandle, FetchOrientation, FetchOffset, RowCountPtr,
		RowStatusArray)));
}
// ////////////////////////////////////////////////////////////////////////////
