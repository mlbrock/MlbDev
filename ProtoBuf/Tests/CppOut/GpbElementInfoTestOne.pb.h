...
#ifndef PROTOBUF_GpbElementInfoTestOne_2eproto__INCLUDED
#define PROTOBUF_GpbElementInfoTestOne_2eproto__INCLUDED
...
class Person_PhoneNumber : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* number_;
  int type_;
  friend void  protobuf_AddDesc_GpbElementInfoTestOne_2eproto();
  friend void protobuf_AssignDesc_GpbElementInfoTestOne_2eproto();
  friend void protobuf_ShutdownFile_GpbElementInfoTestOne_2eproto();
...
#endif  // PROTOBUF_GpbElementInfoTestOne_2eproto__INCLUDED
