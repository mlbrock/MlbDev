...
/*
	...
	File Description	:	Definition of the PacketFileReaderTmp class.
...
#ifndef HH__MLB__SocketIo__PacketFileReaderTmp_hpp__HH

#define HH__MLB__SocketIo__PacketFileReaderTmp_hpp__HH	1
...
// ////////////////////////////////////////////////////////////////////////////
class PacketFileReaderTmp {
public:
	PacketFileReaderTmp(const std::string &file_name, PacketFormat packet_format);
...
private:
	...
	boost::shared_array<unsigned char> packet_buffer_sptr_;

	class FileOffsetSaver {
	public:
		FileOffsetSaver(PacketFileReaderTmp &reader_ref)
	...
	private:
		PacketFileReaderTmp   &reader_ref_;
	...
	PacketFileReaderTmp(const PacketFileReaderTmp &other);
	PacketFileReaderTmp & operator = (const PacketFileReaderTmp &other);
};
// ////////////////////////////////////////////////////////////////////////////

// ////////////////////////////////////////////////////////////////////////////
typedef boost::shared_ptr<PacketFileReaderTmp> PacketFileReaderTmpSPtr;
// ////////////////////////////////////////////////////////////////////////////

// ////////////////////////////////////////////////////////////////////////////
template <typename DataType>
	bool PacketFileReaderTmp::GetPacketTyped(std::size_t &packet_length,
		const DataType *&packet_ptr)
{
...
// ////////////////////////////////////////////////////////////////////////////
template <typename DataType>
	bool PacketFileReaderTmp::GetPacketTyped(const DataType *&begin_ptr,
...
#endif // #ifndef HH__MLB__SocketIo__PacketFileReaderTmp_hpp__HH
